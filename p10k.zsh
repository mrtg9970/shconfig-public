# Generated by Powerlevel10k configuration wizard on 2020-06-09 at 22:24 +08.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh, checksum 50047.
# Wizard options: powerline, unicode, lean_8colors, 24h time, 1 line, compact, fluent.
...
() {
  ...
  typeset -g POWERLEVEL9K_OS_ICON_CONTENT_EXPANSION='[ ec2-dev'
  ...
  typeset -g POWERLEVEL9K_ANACONDA_VISUAL_IDENTIFIER_EXPANSION='py'
